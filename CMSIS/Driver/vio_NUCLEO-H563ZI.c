...
| vioLED0       | vioSignalOut.0 | LED red     (LD3)  | PG4
| vioLED1       | vioSignalOut.1 | LED green   (LD1)  | PB0
| vioLED2       | vioSignalOut.2 | LED yelow   (LD2)  | PF4
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTG(4),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED1,    GPIO_PIN_ID_PORTB(0),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH },
  { vioLED2,    GPIO_PIN_ID_PORTF(4),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_HIGH }
};
#endif
